# CLR-via-C-Sharp-NOTES-RUS

Конспект по кинге Джеффри Рихтера CLR via C\# \(RUS\). \(В процессе написания\)

---

### Источники: [CLR via C\#. Программирование на платформе Microsoft .NET Framework 4.5 на языке C\#](https://github.com/micros-uz/csharp/tree/master/Level 1/Books)
